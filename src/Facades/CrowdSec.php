 ...
 * @method static void addThreatScoreFromThreats(string $ip, array $threats)
 ...
 * @method static \RiloArbabillah\LaravelCrowdSec\Models\SecurityEvent logEvent(string $ip, array $threats, \Illuminate\Http\Request $request, ?string $actionTaken = null)
